defmodule Summoner.Conversations do
  @moduledoc """
  ...
  alias Summoner.Conversations.{Content, Conversation, ConversationParticipant, Message}
  ...
  defp maybe_add_inference_snapshot(attrs) do
    ...
    if agent_id do
      ...
      Map.merge(attrs, Agents.Agent.inference_snapshot(agent))
    else
      attrs
    end
  end

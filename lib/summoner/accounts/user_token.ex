defmodule Summoner.Accounts.UserToken do
  @moduledoc """
  Schema and query helpers for user authentication tokens.
  """
  ...
  alias Summoner.Accounts.UserToken
  ...
  schema "users_tokens" do
    ...
    belongs_to :user, Summoner.Accounts.User

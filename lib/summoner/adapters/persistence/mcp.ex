defmodule Summoner.Adapters.Persistence.MCP do
  @moduledoc """
  ...
  alias Summoner.Domain.Events.AgentConfigChanged
  alias Summoner.Domain.Schemas.{AgentMcpServer, McpServer}
  alias Summoner.Ports.Events
  alias Summoner.Repo
  alias Summoner.Services.MCP.ClientBridge
  ...
  def notify_tools_changed(agent_id) do
    Events.publish(%AgentConfigChanged{agent_id: agent_id})
  end

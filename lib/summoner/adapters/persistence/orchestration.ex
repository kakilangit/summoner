defmodule Summoner.Adapters.Persistence.Orchestration do
  @moduledoc """
  ...
  alias Summoner.Domain.Schemas.{Invocation, InvocationEvent, InvocationStep, Subtask}
  ...
  def add_event(attrs) do
    ...
    with {:ok, event} <-
           ...
           |> Repo.insert() do
      if workspace_id do
        Events.publish(%InvocationEventNotification{

defmodule Summoner.Pipelines do
  @moduledoc """
  The Pipelines context.

  Manages pipeline definitions (ordered sequences of agents).
  Pipeline execution is handled by `Summoner.Orchestration.PipelineRunner`.
  """

  import Ecto.Query, warn: false

  alias Summoner.Conversations
  alias Summoner.Orchestration.{Cancellation, Invocation}
  alias Summoner.Pagination
  alias Summoner.Pipelines.{Pipeline, PipelineRun, PipelineRunStage, PipelineStage}
  alias Summoner.Repo

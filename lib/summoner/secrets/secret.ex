defmodule Summoner.Secrets.Secret do
  @moduledoc """
  Schema for workspace-scoped or tenant-scoped secrets (Seals).

  Values are encrypted at rest via `Summoner.Encrypted.Binary`
  ...
  schema "secrets" do
    field :name, :string
    field :encrypted_value, Summoner.Encrypted.Binary
    field :description, :string

    belongs_to :workspace, Summoner.Workspaces.Workspace
    belongs_to :tenant, Summoner.Tenants.Tenant

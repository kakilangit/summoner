defmodule SummonerWeb.UserAuth do
  @moduledoc """
  Plugs for user authentication, session management, and authorization.
  """
  ...
  Use in router:
      live_session :authenticated, on_mount: [{SummonerWeb.UserAuth, :ensure_authenticated}]
  """
  def on_mount(:ensure_authenticated, _params, session, socket) do
    socket = mount_current_scope(socket, session)

    if socket.assigns.current_scope && socket.assigns.current_scope.user do
      if socket.assigns.current_scope.user.disabled_at do
        socket =
          socket
  ...
  def log_out_user(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      SummonerWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  def require_authenticated_user(conn, _opts) do
    cond do
      ...
      conn.assigns.current_scope.user.disabled_at != nil ->
        conn

...
config :summoner, SummonerWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "UDoMKwSZ0VM2SGxEq97+e9x6Kgpb+acYNpEUD2AQ5+LLrYheB59/nbB0WKGCE3PD",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:summoner, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:summoner, ~w(--watch)]}
  ]
...
config :summoner, SummonerWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"lib/summoner_web/router\.ex$"E,
      ~r"lib/summoner_web/(controllers|live|components)/.*\.(ex|heex)$"E
    ]
  ]
